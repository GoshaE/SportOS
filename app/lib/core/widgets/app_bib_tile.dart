                ...
                children: [
                  if (lapInfo != null)
                    Padding(
                      ...
                      child: Text(
                        lapInfo!,
                        style: Theme.of(context).textTheme.labelSmall?.copyWith(fontSize: 10, fontWeight: FontWeight.bold, color: textColor.withOpacity(0.6), height: 1.0),
                      ),
                    ),
                  Text(
                    bib,
                  ...
                  if (name != null)
                    Padding(
                      ...
                      child: Text(
                        ...
                        style: Theme.of(context).textTheme.labelSmall?.copyWith(fontWeight: FontWeight.w500, color: textColor.withOpacity(0.9)),
                      ),
                    ),
                ],
              ),
